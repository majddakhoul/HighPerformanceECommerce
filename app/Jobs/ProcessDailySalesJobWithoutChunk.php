...
class ProcessDailySalesJobWithoutChunk implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $orders = Order::whereDate('delivered_at', $this->date)
        ...
        $summary = DB::table('daily_product_sales')
            ...
            ->selectRaw('SUM(total_quantity) as total_qty, SUM(total_revenue) as total_rev, SUM(total_cost) as total_cost, SUM(profit) as total_profit')
            ->first();
